...
function initFormatadorDados() {
    if (!document.getElementById('input-dados') || document.getElementById('input-dados').dataset.initialized) return;
    document.getElementById('input-dados').dataset.initialized = 'true';
...
document.addEventListener('DOMContentLoaded', initFormatadorDados);
document.addEventListener('turbo:load', initFormatadorDados);
