"""
Propósito: Script CLI unitário para auditar se há bolsas divergentes.
"""
import pandas as pd
import os
...
ARQ_PAGAMENTOS = os.path.join(settings.BASE_DIR, "apps", "automacoes", "analise_ia", "dados", "analise_pagamentos", "CONSOLIDADO", "consolidado_pagamentos.parquet")
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        """
        O QUE FAZ: Identifica bolsistas que tiveram mensalidade oscilando dentro do mesmo semestre (ex: pagou 300 e depois 350).
        """
        ...
        df = pd.read_parquet(ARQ_PAGAMENTOS)
        ...
        # Grouping e Estatística para achar onde Min != Max
        ...
        # Impressão Customizada e Formatada
