...
class Usuario(AbstractBaseUser):
    ...
    p_recalculo_bolsas = models.BooleanField(default=False)
    p_enquadramento_cursos = models.BooleanField(default=False)
    ...
    p_dash_documentos_ia = models.BooleanField(default=False)
