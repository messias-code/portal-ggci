...
# ==========================================
PASTA_CONSOLIDADOS = os.path.join("dados", "dados_analise_ia", "analise_documentos_processados", "CONSOLIDADO")
...
ARQ_AGENDAR = os.path.join("dados", "dados_analise_ia", "analise_documentos_agendar_processamentos", "CONSOLIDADO", "consolidado_agendar_processamentos.xlsx")

PASTA_PAGAMENTOS = os.path.join("dados", "dados_analise_ia", "analise_pagamentos", "CONSOLIDADO")
ARQ_PAGAMENTOS = os.path.join(PASTA_PAGAMENTOS, "consolidado_pagamentos.xlsx")

ARQUIVO_GERAL_SAIDA = os.path.join("dados", "dados_analise_ia", "relatorio_geral.xlsx")
