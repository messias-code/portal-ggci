...
def gerar_resumo_quantitativo(df_target, tipos_documentos):
    ...
    #
    #  O relatório dizia "Total Beneficiários: 247" e, na mesma linha, "Env. RIAF 140 +
    ...
    #
    #  Medido em ANHANGUERA ANÁPOLIS 2026-1: dos 247, 45 só existiam por inadimplência —
    #  41 deles marcados como `Ingresso`, que é o que essa injeção produz por não haver
    #  semestre anterior. Tirando-os, CONTRATO, RIAF e HISTÓRICO passam a dizer 202 os
    #  três, e o total também. Regra do negócio: contrato, histórico e RIAF são devidos
    #  por TODO beneficiário; só benefício e financiamento são condicionais.
