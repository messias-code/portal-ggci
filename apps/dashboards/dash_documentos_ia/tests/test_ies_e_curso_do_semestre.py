"""
=== ARQUIVO: apps/dashboards/dash_documentos_ia/tests/test_ies_e_curso_do_semestre.py ===
...
from apps.dashboards.dash_documentos_ia.services.ggci import mesclar_sql_e_reordenar
