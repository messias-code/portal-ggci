CREATE OR REPLACE VIEW sibu.PY_ggci_espelho_historico_d1_2025_documentos_ia AS
...
WITH UltimaTentativa AS (
    SELECT 
        *,
        ...
        (SELECT l_cur.cur_codigo FROM lancamento l_cur
...
LEFT JOIN cursos c ON c.cur_codigo = COALESCE(u.cur_codigo_semestre, uni.cur_codigo)
