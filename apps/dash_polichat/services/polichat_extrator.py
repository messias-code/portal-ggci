...
# Sobe 3 níveis para chegar na raiz do projeto (de apps/dash_polichat/services para /)
BASE_DIR_PROJETO = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
DOWNLOAD_PATH = os.path.join(BASE_DIR_PROJETO, "dados", "dados_polichat", "analise_anual")
