...
def alterar_senha_page(request):
    ...
    return render(request, 'gestao_acessos/inicio/alterar_senha/index.html')
...
def ferramentas(request):
    ...
    return render(request, 'gestao_acessos/ferramentas/index.html')
...
def formatador_listas(request):
    ...
    return render(request, 'gestao_acessos/ferramentas/formatador_listas/index.html')
...
def formatador_dados(request):
    ...
    return render(request, 'gestao_acessos/ferramentas/formatador_dados/index.html')
...
def analise_ia_view(request):
    ...
    return render(request, 'analise_ia/analise_ia/index.html')
...
def dash_polichat(request):
    ...
    return render(request, 'dash_polichat/index.html')
...
def gestao_polichat_view(request):
    ...
    return render(request, 'dash_polichat/gestao_polichat/index.html')