...
TAREFAS_MENUS = [
    {"nome_menu": "Análise Contratos Processados", "pasta_raiz": "dados_analise/analise_documentos_processados"},
    {"nome_menu": "Agendar Processamento", "pasta_raiz": "dados_analise/analise_documentos_agendar_processamentos"}
]

PASTA_PAGAMENTOS = "dados_analise/analise_pagamentos"
