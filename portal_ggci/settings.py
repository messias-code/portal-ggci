...
INSTALLED_APPS = [
    ...
    'apps.inicio.alteracao_senha',
    'apps.inicio.gestao_acessos',
    'apps.inicio.menu_inicio',
    'apps.ferramentas.menu_ferramentas',
    'apps.ferramentas.formatador_dados',
    'apps.ferramentas.formatador_listas',
    'apps.automacoes.menu_automacoes',
    'apps.automacoes.analise_ia',
    'apps.automacoes.recalculo_bolsas',
    'apps.automacoes.enquadramento_cursos',
    'apps.dashboards.menu_dashboards',
    'apps.dashboards.dash_documentos_ia',
    'apps.dashboards.dash_polichat',
...
MIDDLEWARE = [
    ...
    'apps.inicio.gestao_acessos.middleware.SingleSessionMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD', 'ovg@2026').strip('\'"'),
...
# BANCO DE TESTES
# --------------------------------------------------------------------------
# `manage.py test` cria e destrói um banco próprio, e o usuário `portal_user` não
# tem GRANT de CREATE DATABASE no MySQL — a suíte morria com "Access denied ...
# to database 'test_portal_ggci_dev'" antes de rodar o primeiro teste. Foi por
# isso que, até 18/08/2026, nenhum teste do projeto tocava o ORM: eles todos
# rodavam sobre funções puras.
#
# Trocar para SQLite em memória durante os testes resolve sem depender de root e
# sem afetar dev nem produção: o bloco só age quando o comando é `test`. Como o
# schema é criado pelas migrations, o que se testa continua sendo o mesmo modelo.
# Se algum dia um teste precisar de recurso exclusivo do MySQL, aí sim vale
# conceder o GRANT em vez de manter esta troca.
if 'test' in sys.argv:
    DATABASES['default'] = {
...
# ==========================================================================
LANGUAGE_CODE = 'pt-br' # Idioma nativo interno do framework
TIME_ZONE = 'America/Sao_Paulo'       # Fuso horário padrão do servidor
USE_I18N = True
USE_TZ = True
...
# ==========================================================================
# 9. CONTROLE DE SESSÃO E INATIVIDADE
# ==========================================================================
# Desloga usuários após 20 minutos (1200 segundos) de inatividade
SESSION_COOKIE_AGE = 1200
# Atualiza o tempo de validade a cada clique/interação no site
SESSION_SAVE_EVERY_REQUEST = True
# Se fechar o navegador, também desloga
